        ...
        <Box flex={1}>
          ...
          <List spacing="4" padding="4" fontSize="xl">
            <ListItem>
              ...
              <Text fontSize="md">
                With a credit card you have easy access to credit even when you
                don't have the needed money, this could be considered a con if
                misused
              </Text>
            </ListItem>
            <ListItem>
              ...
              <Text fontSize="md">
                With a credit card you can build a credit history which shows
                your ability to pay your bills off quickly
              </Text>
            </ListItem>
            <ListItem>
              Loss or theft protection
              <Text fontSize="md">
                As long as the owner reports their credit card as lost or stolen
                quickly, they are often only expected to pay a minor fine
                instead of the full amount lost
              </Text>
            </ListItem>
          </List>
        </Box>
          ...
          <List spacing="4" padding="4" fontSize="xl">
            <ListItem>
              ...
              <Box display="flex" flexDirection="column" gap="2">
                <Text fontSize="md">
                  With a seemingly unlimited amount of money at your fingertips,
                  many people will overspend and end up in debt using credit
                  cards
                </Text>
                <Text fontSize="md">
                  Debit cards although have a hard limit, and you can't spend
                  more than you own
                </Text>
              </Box>
            </ListItem>
            <ListItem>
              High interest rates
              <Text fontSize="md">
                If a credit card bill is not paid quickly, then the credit card
                interest rates will very quickly increase the amount owed
              </Text>
            </ListItem>
            <ListItem>
              Extra costs
              <Text fontSize="md">
                With a credit card there exists many less obvious costs such as
                minimum due fees, annual ownership fees, foreign transaction
                fees, exceeding limit fees and credit card surcharges
              </Text>
            </ListItem>
          </List>
        </Box>
